...
import styles from './InformasiTerbaruPopup.module.css';
...
const InformasiTerbaruPopup: Component = () => {
    ...
    <div class={styles.popupOverlay}>
      <div class={styles.popupContent}>
        <div class={styles.popupHeader}>
          <h2>Pilih Informasi Terbaru yang akan di tampilkan</h2>
...
export default InformasiTerbaruPopup;